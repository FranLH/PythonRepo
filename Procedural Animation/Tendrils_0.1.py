...
class Limb:
    def __init__(self, pos:vec2, nodes:int, segmentLengths:list[int|float], speed:int|float, MaxSpeed:int|float, MinSpeed:int|float):
        self.pos, self.speed, self.MaxSpeed, self.MinSpeed = pos, speed, MaxSpeed, MinSpeed
...
L1 = Limb(vec2(420,300),5,[45,37,30,22], 4, 0.5, 4)
L = Limb(vec2(180,300),10,[45,45,45,37,37,37,30,30,22], 4, 0.5, 4)
Limbs = [L,L1]
#L.Backwards()
#print(vec2(23,45)/2)
