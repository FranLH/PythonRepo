...
def Rotated(camR, p):
    return([(p.x*math.cos(camR.y) + (p.y*math.sin(camR.x) + p.z*math.cos(camR.x))*math.sin(camR.y))*math.cos(camR.y) + (p.y*math.cos(camR.x) + p.z*-math.sin(camR.x))*-math.sin(camR.y), (p.x*math.cos(camR.y) + (p.y*math.sin(camR.x) + p.z*math.cos(camR.x))*math.sin(camR.y))*math.sin(camR.y) + (p.y*math.cos(camR.x) + p.z*-math.sin(camR.x))*math.cos(camR.y), p.x*-math.sin(camR.y) + (p.y*math.sin(camR.x) + p.z*math.cos(camR.x))*math.cos(camR.y)])
    #z and y easy
